						...
						<form class="form-horizontal" id="form-secciones" autocomplete="off">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input class="form-control" type="text" id="codigo" maxlength="2" disabled>
									</div>
								</div>
								<div class="form-group">
								...
								<button id="agregar_det" type="button" class="btn btn-primary" onclick="agregarDeterminacion();">Agregar Determinacion</button>
							</fieldset>
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										<input class="btn btn-primary" type="button" id="modificar" value="Modificar Sección" disabled>
									</div>
								</div>
							</div>
						</form>
...
<script src="js/app/mantenimiento-archivos/secciones/modificacion-seccion.js"></script>
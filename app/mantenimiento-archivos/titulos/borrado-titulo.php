						...
						<form id="form-titulo" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="codigo" class="form-control" placeholder="XXX" type="text" maxlength="3" disabled>
									</div>
								</div>
								<div class="form-group">
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										<input class="btn btn-primary" type="button" id="eliminar" value="Eliminar Título" disabled>											
									</div>
								</div>
							</div>
						</form>
...
<script src="js/app/mantenimiento-archivos/titulos/borrado-titulo.js"></script>
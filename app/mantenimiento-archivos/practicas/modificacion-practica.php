	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">						
				<header>							
					<h2>Modificación de Nomenclador Especial</h2>
				</header>
				<!-- widget div-->
				<div>
					<!-- widget edit box -->
						...
						<form class="form-horizontal" id="form-practicas">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-5">
										<input id="buscar_mutual" class="form-control" placeholder="Código: XXXX - Nombre" type="text" list="list_mutuales" disabled>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										<input class="btn btn-primary" type="button" id="modificar" value="Modificar Nomenclador Especial" disabled>
									</div>
								</div>
							</div>
						</form>
...
<script src="js/app/mantenimiento-archivos/practicas/modificacion-practica.js"></script>
<?php
	...
	$ch = curl_init();
	//setup cURL
	$options = array(CURLOPT_URL => 'http://www.entity-studio.com/jjlab/api/planillas/porpaciente',
					 CURLOPT_POST => TRUE,
	...
	else
	{
		...
		class PDF extends FPDF
		{
			...
			function Cabecera()
			{
			    ...
			    //Nombre doc
			    $this->SetTitle('planilla-trabajo-por-pacientes-'.$_SESSION['NombreUsuario'].date('Y-m-d-H:i:s'));
			    ...
			    $this->SetFont('Arial','',10);
			    $this->Ln(10);
			    $this->Cell(0,-12,iconv('UTF-8', 'windows-1252', 'Planilla de Trabajo por Pacientes'));
			}

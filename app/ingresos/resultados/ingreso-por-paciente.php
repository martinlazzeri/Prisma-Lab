		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget col-lg-12" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
				<header>
					...
					<h2>Ingreso de Resultados por Paciente</h2>		
				</header>
				<div>					
					<div class="widget-body no-padding">
						<form class="smart-form" id="form-resultados" autocomplete="off">
							<fieldset>
...
<script src="js/app/ingresos/resultados/ingreso-por-paciente.js"></script>
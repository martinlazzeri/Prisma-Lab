		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
				<header>
					...
					<h2>Ingreso de Pacientes Uno a Uno</h2>				
				</header>
				<!-- widget div-->
				<div>
					<!-- widget edit box -->
							...
							<fieldset>
								<div class="row">
									<section class="col col-md-2">
										<label class="label">Número de Paciente</label>								
										<input type="text" id="num-paciente" required maxlength="8">
									</section>
								</div>							
								<div class="row">									
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" id="nombre" placeholder="Apellido y nombre del paciente" data-value="">												
										</label>
									</section>
...
<script src="js/app/ingresos/pacientes/ingreso-paciente-uno-uno.js"></script>
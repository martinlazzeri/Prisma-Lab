	...
	else
	{
		...
		class PDF extends FPDF
		{
			...
			function Cabecera()
			{
			    ...
			    //Num pagina	    
			    $this->Cell(110,-12,'Pagina '.$this->PageNo().'/{nb}',0,0,'C');
			    ...
			    $this->Cell(0,-12,iconv('UTF-8', 'windows-1252',  $params['IngresoId']));
			}
			...
			function DibujarPacientes($pacientes)
			{
				...
				{	
					...
					foreach ($pacientes as $paciente) 
					{
						...
						{
							$this->Cell(10,10,iconv('UTF-8', 'windows-1252', $ingresoP['PracticaCodigo']));
							$this->Cell(45,10,iconv('UTF-8', 'windows-1252', $ingresoP['PracticaNombre']));
							$this->Cell(45,10,iconv('UTF-8', 'windows-1252', $ingresoP['Resultado'] == null ? 'Pendiente' : 'Completo'));
							$this->Ln(5);
						}

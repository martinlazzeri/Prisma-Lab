	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">						
				<header>							
					<h2>Corrección de Resultados</h2>
				</header>
				<!-- widget div-->
				<div>
					<!-- widget edit box -->
						...
						<form id="form-resultados" class="form-horizontal" autocomplete="off">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-5">
										<input class="form-control" type="text" id="buscar-paciente" placeholder="Número, Apellido, DNI o N° de paciente">
									</div>
								</div>
							</fieldset>	
							<div id="div-campos" hidden>
								...
								<footer>
									<div class="col-md-offset-8">
										<input class="btn btn-primary" type="button" id="modificar" value="Modificar Resultados" disabled>
									</div>
								</footer>	
							</div>					
						</form>
...
<script src="js/app/consulta-correccion/correccion-resultados.js"></script>
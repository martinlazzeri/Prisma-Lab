...
?>
		...
		<!-- DMUploader -->
		<script src="<?php echo ASSETS_URL; ?>/js/plugin/dmuploader/dmuploader.min.js"></script>
		<!--[if IE 8]>
		...
		<?php
		if ($_SESSION['SinConexion'] == 1) 		
		{
			?>
			<script src="<?php echo ASSETS_URL; ?>/js/plugin/cookie/jquery.cookie.js"></script>
			<?php
		}
		else
		{
